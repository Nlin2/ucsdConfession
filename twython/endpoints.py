...
class EndpointsMixin(object):
    ...
    def destroy_direct_message(self, **params):
        ...
        """
        return self.post('direct_messages/events/destroy', params=params)
    ...
    # Welcome message
    def welcome_message(self, **params):
        return self.post('direct_messages/welcome_messages/new', params=params)
    def welcome_message_rules(self, **params):
        return self.post('direct_messages/welcome_messages/rules/new', params=params)
    def quick_reply(self, **params):
        return self.post('direct_messages/new', params=params)
    def schedule_tweet(self, **params):
        return self.post('accounts/:account_id/scheduled_tweets', params=params)
